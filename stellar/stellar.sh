...
if which lizard >/dev/null; then
	echo "Running lizard"
	lizard -l src > ../stellarlizarduncomp.txt
else
...
../../lizardtrim.py ../stellarlizarduncomp.txt
...
if which cppcheck >/dev/null; then
	...
	cppcheck -j 750 -q --force --enable=warning src 2>../stellarcppcheck.txt
else
...
lizard -l src > ../stellarlizard.txt
...
echo "Trimming lizard results"
../../lizardtrim.py ../stellarlizard.txt
...
# while it is running
lcov --directory . --capture --output-file stellar_test.info > /dev/null 2>&1
...
genhtml -o ../../../../lcov stellar_test.info > /dev/null 2>&1
...
echo $((end - start)) > ../../../../stellartime.txt
